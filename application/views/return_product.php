                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Return Damaged Goods</h2>
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Return Damaged Goods</li>
                        </ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>return_product/addEditReturnProduct" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Return Product','return_product/addEditReturnProduct/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    ...
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Product Name</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Return / Damaged Quantity</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Reasons</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align :center">Return / Damaged Quantity</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">damaged due to fire</td>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>return_product/addEditReturnProduct"><li>Edit</li></a>
                                                    */
                                                    ?>
                                                    <li><a href="#" onclick="showAjaxModel('Return Product','return_product/addEditReturnProduct/\'\'/90');">Edit</a>
                                                    </li>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td style="text-align :center">SSD Enterprises</td>
