    ...
    <div class="header-left">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>user/dashboard">
                <?php 
                /*
                <img class="logo" src="http://img.djavaui.com/?create=175x50,81B71A?f=ffffff" alt="brand logo" width="220" height="51">
                */
                ?>
                <img class="logo" src="<?php echo base_url(); ?>/assets/images/logo.png" alt="brand logo" width="220" height="51">
            </a><!-- /.navbar-brand -->
            <!--/ End brand -->
    ...
    <div class="header-right">
        ...
        <div class="navbar navbar-toolbar">
            ...
            <li class="dropdown navbar-message">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-envelope-o"></i><span class="count label label-danger">7</span></a>
            ...
            <li class="dropdown navbar-notification">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell-o"></i><span class="count label label-danger">6</span></a>
            ...
            <li class="dropdown navbar-profile">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="meta">
                        ...
                        <span class="text hidden-xs hidden-sm text-muted"><?php echo ucfirst($user_session_data->user_name); ?></span>
                ...
                <ul class="dropdown-menu animated flipInX">
                    ...
                    */
                    ?>
                    <li><a href="<?php echo base_url()?>user/logoutUser"><i class="fa fa-sign-out"></i>Logout</a></li>
                </ul>
                <!--/ End dropdown menu -->
