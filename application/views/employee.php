                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Employee</h2>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>Employee/addEditEmployee" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Employee','Employee/addEditEmployee/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Employee Name</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Email Id</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Address</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Phone Number</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Distribution Level</a>
                                    </li>
                                     <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Distributor Name</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">Pratik Parikh</td>
                                                <td style="text-align :center">Pratik@gmail.com </td>
                                                <td style="text-align :center">12,vijayangar</td>
                                                <td style="text-align :center">0736541321</td>
                                                <td style="text-align :center">State</td>
                                                <td style="text-align :center">MP,Delhi,PNB,MH,GJ</td>
                                                <td style="text-align :center"></td>
                                                <td style="text-align :center">VKN Enterprises,SD Associates,Rawat Associates,Streets,Ganesh Stockist</td>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>Employee/addEditEmployee"><li>Edit</li></a>
                                                    */
                                                    ?>
                                                    <li><a href="#" onclick="showAjaxModel('Employee','Employee/addEditEmployee/\'\'/90');">Edit</a>
                                                    </li>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">Jayes Shah</td>
                                                <td style="text-align :center">Pr123@gmail.com </td>
                                                <td style="text-align :center">11,vijayangar</td>
                                                <td style="text-align :center">0732121321</td>
                                                <td style="text-align :center">City</td>
                                                <td style="text-align :center">MP</td>
                                                <td style="text-align :center">Indore,Ujjain,Dewas,Gwalior</td>
                                                <td style="text-align :center">JD Movers,Pratap Stockiest</td>
