                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Distributor Order</h2>
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Distributor Order</li>
                        </ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <a href="<?php echo base_url(); ?>Order/addEditOrder" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                    </div>                       
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Order Date</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Delivered Date</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Order Dispatched Date</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Approx delivery Date</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Delivered Status</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Remarks</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Created By</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align :center">Order Dispatched Date</th>
                                                <th style="text-align :center">Approx delivery Date</th>
                                                <th style="text-align :center">Delivered Status</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>Order/addEditOrder"><li>Edit</li></a>
                                            ...
                                            <tbody>
                                               ...
                                               <td style="text-align :center">Lays</td>
                                                ...
                                                <td style="text-align :center"></td>
                                                <td style="text-align :center">Mahindra Singh</td>
                                                <td style="text-align :center">2016-05-05 15:00:00</td>
                                                <td style="text-align :center"></td>
                                                <td><div class="btn-group">
                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
