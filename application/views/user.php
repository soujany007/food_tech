                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Users</h2>
                            ...
                            <div class="panel rounded shadow no-overflow">
                                <div class="panel-heading">
                                    <div class="dt-buttons pull-left">
                                        <?php 
                                        /*
                                        <a href="<?php echo base_url(); ?>user/addEditUser" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                                        */
                                        ?>
                                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('User','user/addEditUser/\'\'/90');"><span>Add New</span></a>
                                    </div>                       
                                        ...
                                        <div class="btn-group">
                                          ...
                                          <i class="fa fa-columns"></i></button>
                                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                                    <li>
                                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>User Name</a>
                                                    </li>
                                                    <li>
                                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Email Id</a>
                                                    </li>
                                                    <li>
                                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Company Name</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="table-responsive">
                                                <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <!--<td style="text-align :center">Priniti Foods Pvt. Ltd.</td>-->
                                                        <td style="text-align :center">VKN Enterprises,JD Associates,SD Associates</td>
                                                        <td style="text-align :center">Jagdish Yadav</td>
                                                        <td><div class="btn-group">
                                                            ...
                                                            <?php 
                                                            /*
                                                            <a href="<?php echo base_url(); ?>user/addEditUser"><li>Edit</li></a>
                                                            */
                                                            ?>
                                                            <li><a href="#" onclick="showAjaxModel('User','user/addEditUser/\'\'/90');">Edit</a>
                                                            </li>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <!--<td style="text-align :center">Priniti Foods Pvt. Ltd.</td>-->
                                                            <td style="text-align :center">V Enterprises</td>
                                                            <td style="text-align :center">Mahendra Singh</td>
                                                            <td><div class="btn-group">
                                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                    <i class="fa fa-cogs"></i>
