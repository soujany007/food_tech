...
<!DOCTYPE html>
    <head>
        ...
        <script src="<?php echo base_url()?>/assets/assets/admin/js/pages/blankon.layout.js"></script>
    ...
    <body>
        ...
        <link href="<?php echo base_url()?>/assets/assets/admin/css/plugins.css" rel="stylesheet">
        <script src="<?php echo base_url()?>/assets/assets/admin/js/apps.js"></script>
        <?php $current_entity = $this->router->fetch_class();
        if($current_entity == 'calendar'){ ?>
        <script src="<?php echo base_url()?>assets/assets/admin/js/pages/blankon.calendar.js"></script>
        <?php }?>
        <!--<script>
            (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
                (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
        ...
        */
        ...
        <script>
            function submitFileMoldelForm(form_id,page_url,parentDivId){ 
             if(form_id!=''){
