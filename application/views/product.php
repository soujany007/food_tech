                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Product</h2>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>Product/addEditProduct" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Product','Product/addEditProduct/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                     <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Product Title</a>
                                    </li>

                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Product Type</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Product Price</a>
                                    </li>
                                    <li>
                                        ...
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>Product/addEditProduct"><li>Edit</li></a>
                                                    */
                                                    ?>
                                                    <li><a href="#" onclick="showAjaxModel('Product','Product/addEditProduct/\'\'/90');">Edit</a>
                                                    </li>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">kurkure circle</td>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">Diamond Finger</td>
