                                    ...
                                    <form class="form-horizontal form-bordered" role="form" id="basic-validate" action="#">
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control input-sm" name="product_title" placeholder="Enter Title" value="Lays">
                                                </div>
                                            </div><!-- /.form-group -->
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Product Type</label>
                                                <div class="col-sm-2">
                                                    <select id="level" name="product_type" class="form-control input-sm" >
                                                        <option value="1" selected>Chips</option>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">Product price<span class="asterisk">*</span></label>
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control input-sm" name="product_price" placeholder="Enter Title" value="10">
                                                </div>
                                            </div><!-- /.form-group -->
