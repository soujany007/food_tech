                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Product And Attribute</h2>
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Product And Attribute</li>
                        </ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <!--<div class="dt-buttons pull-left">
                        <a href="add_edit_product_master_attr.html" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                    </div>-->
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    ...
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Product Attribute</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <!--<a href="add_edit_product.html"><li>Edit</li></a>-->
