                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Market</h2>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>Market/addEditMarket" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Market','Market/addEditMarket/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                     <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Title</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Description</a>
                                    </li>
                                     <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Distribution Level</a>
                                    </li>
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Level</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">MP & CG</td>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>Market/addEditMarket"><li>Edit</li></a>
                                                    */
                                                    ?>                                                    
                                                    <li><a href="#" onclick="showAjaxModel('Market','Market/addEditMarket/\'\'/90');">Edit</a>
                                                    </li>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">East Indore</td>
                                                <td style="text-align :center">Sales</td>
