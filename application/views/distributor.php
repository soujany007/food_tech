                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Distributors</h2>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>Distributor/addEditDistributor" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Distributor','Distributor/addEditDistributor/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    ...
                                    <li>
                                        <a data-column="2" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Head Distributor</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">VKN Enterprises</td>
                                                <td style="text-align :center">vkn@gmail.com</td>
                                                <td style="text-align :center">12,vijanagar</td>
                                                <td style="text-align :center">074321321</td>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>Distributor/addEditDistributor"><li>Edit</li></a>
                                                    */
                                                    ?>
                                                    <li><a href="#" onclick="showAjaxModel('Distributor','Distributor/addEditDistributor/\'\'/90');">Edit</a>
                                                    </li>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">Krati Sales And Distribution</td>
                                                <td style="text-align :center">k@gmail.com</td>
                                                <td style="text-align :center">11,vijanagar</td>
                                                <td style="text-align :center">07421321</td>
                                                <td style="text-align :center">Sales</td>
                                                <td style="text-align :center">City</td>
                                                <td style="text-align :center">VKN Enterprises, SD Associates</td>
