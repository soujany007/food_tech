                ...
                <div class="header-content">
                    <h2><i class="fa fa-table"></i>Employee Beat Instance</h2>
                    <div class="breadcrumb-wrapper hidden-xs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Employee Beat Instance</li>
                        </ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="dt-buttons pull-left">
                        <?php 
                        /*
                        <a href="<?php echo base_url(); ?>employee_beat_instance/addEditEmployeeBeatInstance" tabindex="0" class="runner rounded btn btn-mini btn-warning btn-slideright btn-block"><span>Add New</span></a>
                        */
                        ?>
                        <a class="runner btn btn-mini btn-warning btn-slideright" tabindex="0" href="javascript:void('');" onclick="showAjaxModel('Employee Beat Instance','employee_beat_instance/addEditEmployeeBeatInstance/\'\'/90');"><span>Add New</span></a>
                    </div>                       
                        ...
                        <div class="btn-group">
                          ...
                          <i class="fa fa-columns"></i></button>
                                <ul class="dropdown-menu pull-right dropdown-toggle-column">
                                    ...
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Beat Allowted Date</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Distributor Name</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Task Done Date</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Created By</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Created Date</a>
                                    </li>
                                    <li>
                                        <a data-column="1" class="toggle-column" href="javascript:void(0);"><i class="fa fa-check-circle-o"></i>Updated Date</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="region_table" class="table table-default table-middle table-striped table-bordered table-condensed">
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align :center">Beat Instance Allowted Date</th>
                                                <th style="text-align :center">Distributor Name</th>
                                                <th style="text-align :center">Task Done Date</th>
                                            ...
                                            <tbody>
                                                ...
                                                <td style="text-align :center">Jai Prakash</td>
                                                <td style="text-align :center">2016-05-05</td>
                                                <td style="text-align :center">MSD Associates</td>
                                                ...
                                                <td><div class="btn-group">
                                                    ...
                                                    <?php 
                                                    /*
                                                    <a href="<?php echo base_url(); ?>employee_beat_instance/addEditEmployeeBeatInstance"><li>Edit</li></a>
                                                    */
                                                    ?>
                                                    <li><a href="#" onclick="showAjaxModel('Employee Beat Instance','employee_beat_instance/addEditEmployeeBeatInstance/\'\'/90');">Edit</a>
                                                    </li>
                                                ...
                                                <td style="text-align :center">prakash chouhan</td>
                                                <td style="text-align :center">2016-05-08</td>
                                                <td style="text-align :center">VKN Enterprices</td>
