...
class Product_attribute extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('Product_attribute_manager');
        $this->rpm = $this->Product_attribute_manager;
    }
    ...
    function index(){
        ...
        $vars['meta_keywords']      = '';
        $vars['heading']            = 'Product Attribute List';
        $vars['content_view']       = 'product_attribute';
        $this->load->view('list_layout',$vars);
    }

    function addEditProductAttribute($product_type_attribute_id='', $customWidth='')
    {
        /*
        checkLoginSession();
        $user_session_data = getUserSession();        
        ...
        $vars['meta_keywords'] = '';
        $vars['heading'] = $head;
        $vars['content_view'] = 'add_edit_product_attribute';
        $this->load->view('list_layout',$vars);
        */
        checkLoginSession();
        $error='';
        ...
        $product_type_attribute_data=array();
        if(!empty($user_session_data)){
            $head = 'Add';
            if(!empty($product_type_attribute_id)){
                $head = 'Edit';
                //$product_type_attribute_data =$this->rpm->getCompanyDataById($product_type_attribute_id);
            ...
            $vars['dataArr']= !empty($product_type_attribute_data) ? $product_type_attribute_data : $this->input->post();
            //echo "<pre>";print_r($vars['dataArr']);die();
            $data = $this->load->view('add_edit_product_attribute',$vars,true);
            $returnArr['data'] = $data;
