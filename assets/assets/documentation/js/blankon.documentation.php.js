var BlankonDocumentationPHP = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonDocumentationPHP.handleHeaderDropdownMenu();
            BlankonDocumentationPHP.handleSidebarLeftActive();
            BlankonDocumentationPHP.handleSmoothScroll();
            BlankonDocumentationPHP.handleCodePrettify();
            BlankonDocumentationPHP.handleSelect2();
            BlankonDocumentationPHP.handleSelect2QuickSearch();
            BlankonDocumentationPHP.handleDatatableChangeLog();
        },
            ...
            $eventSelectQuickSearch.on('select2:select', function () {
                ...
                if (url) { // require a URL
                    if($('.live-preview-doc').length){
                        window.open(getBaseURL()+'/live-preview/admin/php/index.php?v='+url, '_blank') ; // redirect live preview
                    }else{
                        window.open(getBaseURL()+'/production/admin/php/index.php?v='+url, '_blank') ; // redirect templates
                    }
