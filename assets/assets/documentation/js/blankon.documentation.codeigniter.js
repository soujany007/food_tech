            ...
            $eventSelectQuickSearch.on('select2:select', function () {
                ...
                if (url) { // require a URL
                    if($('.live-preview-doc').length){
                        window.open(getBaseURL()+'/live-preview/admin/codeigniter/'+url, '_blank') ; // redirect live preview
                    }else{
                        window.open(getBaseURL()+'/production/admin/codeigniter/'+url, '_blank') ; // redirect templates
                    }
