var BlankonDocumentationYii= function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonDocumentationYii.handleHeaderDropdownMenu();
            BlankonDocumentationYii.handleSidebarLeftActive();
            BlankonDocumentationYii.handleSmoothScroll();
            BlankonDocumentationYii.handleCodePrettify();
            BlankonDocumentationYii.handleSelect2();
            BlankonDocumentationYii.handleSelect2QuickSearch();
            BlankonDocumentationYii.handleDatatableChangeLog();
        },
            ...
            $eventSelectQuickSearch.on('select2:select', function () {
                ...
                if (url) { // require a URL
                    if($('.live-preview-doc').length){
                        window.open(getBaseURL()+'/live-preview/admin/yii2/web/index.php?r='+url, '_blank') ; // redirect live preview
                    }else{
                        window.open(getBaseURL()+'/production/admin/yii2/web/index.php?r='+url, '_blank') ; // redirect templates
                    }
