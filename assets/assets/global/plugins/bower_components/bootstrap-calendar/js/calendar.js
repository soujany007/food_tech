...
(function($) {
	...
	Calendar.prototype.navigate = function(where, next) {
		...
		this.options.events_source = base_url+'calendar/event_list/'+this.options.view+'/'+this.options.day;
		this.view();
	...
	Calendar.prototype._update = function() {
		...
		$('*[data-cal-date]').click(function() {
			...
			$.ajax({
                type: "POST",
                url: base_url +'calendar/calendar_task_event',
                cache:false,
                data: '',
                success: function(msg){
                    var obj = jQuery.parseJSON(msg);
                    $('.calendar_popup_content').html(obj.data);
                }
            });
		});
	...
	Calendar.prototype._update_month_year = function() {
		...
		$('.cal-month-day, .cal-year-box .span3')
			...
			.on('click', function(event) {
				var clicked_date = $(this).children('span').data('cal-date');
				$('#add-event-modal').modal('show');
				$.ajax({
					type: "POST",
					url: base_url +'calendar/calendar_task_event',
